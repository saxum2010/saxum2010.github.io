...
var catalog = [
  ...
  {key:"17", title:'segolo.com', desc:'Сайт Cергея Головань', link:'http://segolo.com', img:'segolo.jpg', tags:'PHP, HTML, Wordpress, Дизайн сайта, логотип', full_title:'segolo.com', full_desc:'Персональный блог свадебного видеооператора Cергея Головань'},
  ...
  {key:"19", title:'opt.tu.odessa.ua', desc:'Система обслуживания постоянных клиентов компании ТехноЮг', link:'http://opt.tu.odessa.ua', img:'opt.jpg', tags:'PHP, HTML,Opencart, Дизайн сайта, логотип, Администрирование', full_title:'tu.odessa.ua', full_desc:'Компания «ТЕХНОЮГ» имеет 25-летний опыт работы на канцелярском рынке Украины. Основные направления: оптовая торговля, комплексное обслуживание офисов, поставка канцелярских товаров по Южному региону Украины.'},
  {key:"20", title:'fashion-butik.com.ua', desc:'Фешн бутик - женская одежда оптом от производителя', link:'http://fashion-butik.com.ua', img:'fashion.jpg', tags:'PHP, HTML, Opencart, Дизайн сайта', full_title:'fashion-butik.com.ua', full_desc:'Фешн бутик - женская одежда оптом от производителя'},
  {key:"21", title:'moda-italia.com.ua', desc:'MODA ITALIA textiles- эксклюзивная ткань оптом', link:'http://moda-italia.com.ua/', img:'moda.jpg', tags:'PHP, HTML, Opencart, Дизайн сайта', full_title:'moda-italia.com.ua', full_desc:'MODA ITALIA textiles- эксклюзивная ткань оптом'},
  {key:"21", title:'moda-italia.com.ua', desc:'MODA ITALIA textiles- эксклюзивная ткань оптом', link:'http://moda-italia.com.ua', img:'tigraiko.jpg', tags:'PHP, HTML, Opencart, Дизайн сайта', full_title:'moda-italia.com.ua', full_desc:'MODA ITALIA textiles- эксклюзивная ткань оптом'},
  ...
  {key:"23", title:'gemforest.com.ua', desc:'Интернет магазин GEMFOREST', link:'http://gemforest.com.ua', img:'gemforest.jpg', tags:'PHP, HTML, Opencart, Дизайн сайта', full_title:'gemforest.com.ua', full_desc:'Интернет магазин драгоценных и полудрагоценных камней GEMFOREST'},
  {key:"24", title:'barbacoa.com.ua', desc:'Сайт ресторана Barbacoa', link:'http://barbacoa.com.ua', img:'barbacoa.jpg', tags:'PHP, HTML, Drupal, Дизайн сайта', full_title:'barbacoa.com.ua', full_desc:'Сайт ресторана Barbacoa'},
  {key:"24", title:'sunny-kids.com.ua', desc:'Солнечные детки   Интернет   магазин детских вещей', link:'http://sunny-kids.com.ua', img:'kids.jpg', tags:'PHP, HTML, Opencart, Дизайн сайта', full_title:'sunny-kids.com.ua', full_desc:'Солнечные детки   Интернет   магазин детских вещей'},
  {key:"25", title:'akumservice.od.ua', desc:'Интернет  магазин аккумуляторов', link:'http://akumservice.od.ua', img:'akumservice.jpg', tags:'PHP, HTML, Opencart, Дизайн сайта', full_title:'akumservice.od.ua', full_desc:'Интернет  магазин аккумуляторов'},
];
